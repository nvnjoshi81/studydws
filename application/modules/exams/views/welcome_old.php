...
if($subject_id==''||$subject_id<1){                   
                ...
                ?>
				<div class="clearfix"></div><div id="page-inner" class=" container exam_page_cont">
                    <!-- /. ROW  -->
                    <div class="row">
                        <?php
            	...
            	<div class="s-sub rcorners2">
                        ...
                        //echo "<i class='fa fa-book fa-4x text-warning'></i>";
                             ?>                                     <img class="img-responsive" width="50px" height="30px" src="<?php echo base_url($imagepath);?>">
                                        ...
                                        <div class="col-md-5 col-sm-5 col-xs-5"><?php  echo "<h4 class='text-primary' >{$subjectName} </h4>"; ?>                           
  	...
  	<div class="row col-list center-block">
		...
		<div class="col-md-6 col-sm-4 col-lg-4  btn-sm btn-xs btn-sm btn-md">
			<div class="col-head text-center">
			     <a href="<?php echo base_url("solved-papers"); ?>"> <img class="img-responsive" src="<?php echo base_url('assets/images/free-solved-papers.png'); ?>" /></a>
			</div>
			</div>
		<div class="col-md-6 col-sm-4 col-lg-4 btn-sm btn-xs btn-sm btn-md">
			<div class="col-head text-center">
			   <a href="<?php echo base_url("sample-papers"); ?>"><img class="img-responsive" src="<?php echo base_url('assets/images/free-sample-paper.png'); ?>" /></a>
			</div>
			</div>
			
		<div class="col-md-6 col-sm-4 col-lg-4 btn-sm btn-xs btn-sm btn-md">
			<div class="col-head text-center">
			     <a href="<?php echo base_url("question-bank"); ?>"><img class="img-responsive" src="<?php echo base_url('assets/images/free-questions-bank.png'); ?>" /></a>
			</div>
			</div>
		<div class="col-md-6 col-sm-4 col-lg-4 btn-sm btn-xs btn-sm btn-md">
			<div class="col-head text-center">
			     <a href="<?php echo base_url("notes"); ?>"><img class="img-responsive" src="<?php echo base_url('assets/images/free-notes.png'); ?>" /></a>
			</div>
			</div>
		<div class="col-md-6 col-sm-4 col-lg-4 btn-sm btn-xs btn-sm btn-md">
			<div class="col-head text-center">
			     <a href="<?php echo base_url("study-packages"); ?>"><img class="img-responsive" src="<?php echo base_url('assets/images/study-packages.png'); ?>" /></a>
			</div>
			</div>
		<div class="col-md-6 col-sm-4 col-lg-4 btn-sm btn-xs btn-sm btn-md">
			<div class="col-head text-center">
			     <a href="<?php echo base_url("free-videos"); ?>"><img class="img-responsive" src="<?php echo base_url('assets/images/video-lectures.png'); ?>" /></a>
			</div>
			</div>
...
<div class="price"><h6 class="vid_prod_hed"><?php echo $video->title?></h6></div>
                                    </div>  
             </a>
    ...
    foreach ($ar as $list) { 
		   ...
		   ?>                                     <li>
                            ...
                            <div class=" col-sm-6 col-md-6">
                                <div class="panel panel-success">
                                    <div class="panel-heading">
                                        <h4 class="col-sm-12 col-md-7">Ncert Solutions <?php if($ns_package!=''&&$ns_package>0){ ?> for <?php echo $ns_package; ?> Chapters<?php } ?></h4><span class="col-md-5 text-right nopadding"><?php if($ns_questions!=''&&$ns_questions>1){ ?> (<?php echo $ns_questions; ?> Questions)<?php } ?></span>
...
<?php } ?>
    ...
    <?php } ?>
                                ...
                                <?php if ($ns_package > 0) { ?>  <!--Ncert Solutions -->   
                        <div class="col-xm-6 col-md-4 col-sm-6 col-md-6">
                            <div class="col-md-4 text-center">
                                   <p class="detail_product_img">  
