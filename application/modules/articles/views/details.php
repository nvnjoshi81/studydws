      ...
      <?php $this->load->view('common/breadcrumb');?>
       ...
       <div class="col-md-9 articledetails">
        <div class="panel panel-success">
          ...
          <div class="">
            <p class="col-md-5"><strong>Category : </strong> <i><a title="<?php echo $category->name;?>" href="<?php echo base_url()?>articles/<?php echo url_title($category->name,'-',true).'/'.$category->id;?>">
                                    <?php echo $category->name;?>
                                </a>
                
                
                </i><?php //echo $postdetails->views?></p>
            <p class="col-md-7 pull-right text-right"><?php //echo date('D, F jS Y',$postdetails->dt_created);?></i></p>
          </div>
