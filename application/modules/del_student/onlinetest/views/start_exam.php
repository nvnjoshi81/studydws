...
<li>
              ...
              <span>
			   ...
			   <li><input type="checkbox" id="nta_ch" name="nta_layout" value="1"> Check for National Testing Agency format</li>
			   
			   
			   <li><input type="checkbox" id="en_ch" name="en_ch" value="0" checked=checked><a href="#proceed_test"> I agree term and condition.<i class="material-icons">arrow_downward
			   </i></a></li>
			   </ul> </form><?php 
        }
        ?>
  ...
  <div class="card">
    ...
    </div> </div>  <div id="proceed_test"><!--Point for start test scroll--></div> 
...
<a href="#wrapper"><h5>Term and Condition- TOP <i class="material-icons">arrow_upward</i> </h5> </a></li>
