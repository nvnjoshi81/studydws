        ...
        <div class="col-md-12 col-sm-12 prod_list_exam exam_page_cont" >
            ...
            <div class="panel panel-success">
                <div class="panel-heading">
                    ...
                    foreach($qb_section as $key => $qbdata_arr){
            ...
            <div class="card-body">
              ...
              <ul>
                    ...
                    <?php   } ?>
                       ...
                       <div class="panel-heading">
               <h4><?php echo ucwords($key); ?> Test Series</h4> 
                </div>     
                            <div class="panel panel-success">
                
                 <div>
                  <ul>
                      <?php foreach($qbdata_arr as $qbdata){ ?>
                    <li>
                        <i class="material-icons icon_bullet">picture_as_pdf</i>
                              <a href="<?php echo generateContentLink_custom('online-test',$qbdata->exam,$qbdata->subject,$qbdata->chapter,$qbdata->name,$qbdata->exam_id,$qbdata->subject_id,$qbdata->chapter_id,$qbdata->id);?>">
                                  <?php echo $qbdata->name;?>
                              </a>
                    </li>
                    <?php   } ?>
                      </ul>
            ...
            <div class="col-md-6 col-sm-6">
              <div class="panel panel-success">
                <div class="panel-heading">
                 ...
                 <div>
                  <ul>
                    <?php $cc=0; foreach($sp_test as $spdata){ ?>
                    <li>
                        <i class="material-icons icon_bullet">picture_as_pdf</i>
...
?></div>
  	 ...
  	 ?>
    <div class="col-md-12 col-sm-12">
	<?php echo  $this->load->view('common/product_list_testseries'); ?></div>
         <?php  } ?>
</div>
</div>
</div>
