...
<div id="wrapper">
    <div class="container">
        <div class="row"><a href="#" onclick="changeCSS('<?php echo get_assets('assets/frontend/css/std-ot.css');?>', 0,'std');"><b>STUDYADDA THEAM</b></a> &nbsp;
        <a href="#" onclick="changeCSS('<?php echo get_assets('assets/frontend/css/nta-ot.css');?>', 0,'nta');"><b>NTA THEAM</b></a>
    ...
    padding: 10px;" class="text-right text-warning" >
				  ...
				  <?php
				   if($nta_layout=='nta'){
					$ntascroll='style="  max-height:450px;
    overflow-y:scroll;"';   
				   }else{
					$ntascroll='';	   
				   }
		...
		$section_disp='';
                    ...
                    <div class="ques_panel_exam">
                       ...
                       for($answer_count=1;$answer_option_count>=$answer_count;$answer_count++){
                              ...
                              <table  class="table table-hover user_ans"style=" max-height:150px;
    overflow-y:scroll; " ><?php
							  if($nta_layout=='nta'){
                                  ?><!--NTA Design-->
                                  <tr class="text-left">
                          ...
                          <?php $showvar='show';
								  $cmoboption .='<td class="col-sm-2 col-md-2">&nbsp;'.$answer_count.')&nbsp;&nbsp;'.'
                                      <input onclick="opt_clicked(\''.$question_id.'\',\''.$showvar.'\');" type="radio" id="single_select_'. $question_id.'_'.$answer_count.'" name="single_select_'. $question_id.'" value="'. $answerid_array[$question_id][$answer_count].'">&nbsp;&nbsp;&nbsp;&nbsp;
				...
				echo ''.$answer_count.')&nbsp;';							
						...
						echo $answer_array[$question_id][$answer_count].''; 
                         ...
                         ?>
                          ...
                          ?>
                        <span class="input-grp-btn btn_online_exam">
                              <a class="btn-md btn-sm btn-lg btn btn-warning btn-raised" href="#" onclick="next_submit(<?php echo $question_count; ?>,'<?php echo $type; ?>',<?php echo $current_question_id ; ?>,<?php echo $onlinetest_id; ?>,<?php echo $usertest_id; ?>,<?php echo $answer_option_count ; ?>,'<?php echo $mtb_answer_count ; ?>','review_submit');" title="Mark for Review and go to Next Question" >Mark To Review & Next</a>
                        </span>  
                        <span class="input-grp-btn btn_online_exam">
                    ...
                    <?php  }else{   ?> 
                              ...
                              <a class="btn-md btn-sm btn btn-warning btn-raised btn-lg" href="#" onclick="next_submit(<?php echo $question_count; ?>,'<?php echo $type; ?>',<?php echo $current_question_id ; ?>,<?php echo $onlinetest_id; ?>,<?php echo $usertest_id; ?>,<?php echo $answer_option_count ; ?>,'<?php echo $mtb_answer_count ; ?>','review_paper_submit');" title="Mark for Review and Submit Online Exam" >Mark To Review & Next</a> <!--review_paper_submit next_paper_submit-->
                  </span> 
                  <span class="input-grp-btn">
                  <a class="btn-md btn-sm btn btn-defaul btn-raised btn-lg" href="#" onclick="next_submit(<?php echo $question_count; ?>,'<?php echo $type; ?>',<?php echo $current_question_id ; ?>,<?php echo $onlinetest_id; ?>,<?php echo $usertest_id; ?>,<?php echo $answer_option_count ; ?>,'<?php echo $mtb_answer_count ; ?>','next_paper_submit');"  title="Save and go to Next Question">Save & Next</a>
                  </span>
                            <?php
							...
							<span style="padding-left: 25px;" class="input-grp-btn btn_online_exam" onclick="opt_clicked('<?php echo $current_question_id; ?>','hide')" >
                             <span style="display:<?php echo $cleare_status; ?>" id="span_clear_btn_<?php echo $current_question_id; ?>" >
                                      <a id="clear_btn" class="btn-md btn-sm btn btn-default btn-raised btn-lg" href="#" onclick="clear_response('<?php echo $current_question_id; ?>','<?php echo $mtb_answer_count ; ?>','<?php echo $type; ?>','<?php echo $usertest_id; ?>');" title="Clear Response or Answer Online Exam" >Clear Response</a> </span>
                        </span>
...
<span class="badge">Not visited
                                                </span><span class="badge badge-info">Not answered
                                               </span>
...
<span class="badge badge-warning">Marked for review
                                               </span>
...
function countdown() {
 ...
 document.getElementById('strclock').innerHTML ="<span style='background-color:#0098DA;color:white;cursor:pointer;' onclick='timeshowhide(1)'  class='nta-time-color'><span class='text-left' id='txtClick' style='display:none;' >Click To Hide </span>"+ hour+":"+min+":"+sec+"</span>";
...
<script>
					function changeCSS(cssFile, cssLinkIndex,cssfor='std') {
