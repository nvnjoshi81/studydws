...
<!--
    ...
    <!--For multiple Questions -->
            ...
            <?php $count=1;foreach($questions as $question){  ?>
                ...
                <span class="pull-right view_ans"><a href="<?php echo base_url('study-packages').'/'.url_title($smdetails->name,'-',TRUE).'/'.$smdetails->id.'/'.$question->id; ?>">View Answer <i class="material-icons">play_arrow</i> </a></span>
              </li>
            <?php $count++;} ?>
