    ...
    public function index($examname=null,$exam_id=0,$subjectname=null,$subject_id=0,$chapter_name=null,$chapter_id=0){
        ...
        if (count($subjects_array) > 0) {
                foreach ($subjects_array as $key => $value) {
                    ...
                    $ncertquestions = $this->Ncertsolutions_model->getNcertSolutions($exam_id, $key, 0);
                   
                    $hasncertinsubject+=count($ncertquestions);
        ...
        if($isvalid){
			...
			/*Only for display qcount*/
                       ...
                       if(isset($topicname)){
                        ...
                        if(isset($topicname_array[1])&&$topicname_array[1]>0){
                            $qcount=$topicname_array[1];
                        }else{
                            $qcount=1;
                        } 
                    /*End qcount*/			
			...
			$solname_val=$solname_array[1];
			if(isset($solname_val)&&$solname_val>=0){
