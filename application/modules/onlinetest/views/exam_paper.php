...
<table>
                                                        ...
                                                        <tr>
                                                            <td style="padding: 0px 5px;">Subject :</td>
                                                            <td>  <span class="nta-color"  style="font-weight: bold">[<?php echo $onlinetestinfo->name; ?>]</span></td>
                                                        </tr>
                                                        <tr>
		...
		<!--End Time Block-->
			...
			<div>
              <span>    
                  <div class="instruction_calcuate pull-right">        
         <!--
        ...
        <a href="#" title="Scientific Calculator">
...
<div id="wrapper">
    <div class="container">
        <div class="row"><!--<a href="#" onclick="changeCSS('<?php echo get_assets('assets/frontend/css/std-ot.css');?>', 0,'std');"><b>STUDYADDA THEME</b></a> &nbsp;
...
padding-bottom: 12px;"><?php if(isset($question_answer_array[$question_count]['section'])){ ?><h5>&nbsp;<?php echo $question_answer_array[$question_count]['section_name']; 
	    ...
	    ?>
		<img src="<?php echo base_url('assets/images/QuizIcons/down.png');?>" class="btndown pull-right"> 
		</h5><?php } ?>
		</div>
    </div>
</div>
...
<span class="badge">Not visited
                                                </span><span class="badge badge-danger">Not answered
                                               </span>
...
<span class="badge badge-review-save">Marked for review
                                               </span>
				 ...
				 <div class="panel panel-body panel-default mb0 mt10" style="border:dotted">
                	...
                	<div class="panel-body">
                            ...
                            <div class="panel panel-info rht_stat_section"><a href="#" onclick="static_clicked(<?php echo $static_count; ?>,<?php echo $question_answer_array[$static_count]['question_id']; ?>);" ><h5>&nbsp;<?php echo $question_answer_array[$static_count]['section_name'].' ('.$question_answer_array[$static_count]['section'].')'; ?></h5></a></div>
                            <?php } 
                            ...
                            if(($question_answer_array[$static_count]['section']=='C')&&($section_c_count==1)){
                                $section_c_count++;
                                 ?>
                            <div class="panel panel-info rht_stat_section"> <a href="#" onclick="static_clicked(<?php echo $static_count; ?>,<?php echo $question_answer_array[$static_count]['question_id']; ?>);" ><h5>&nbsp;<?php echo $question_answer_array[$static_count]['section_name'].' ('.$question_answer_array[$static_count]['section'].')'; ?> 
                                </h5></a></div>
                            <?php 
                            }
...
/*End single select*/
       ...
       $("#static_link_"+qid).addClass("badge-danger"); 
    }
        }else{
    ...
    */
    ...
    function(data, status){
       //Nothind to do
    $("#static_link_"+qus_id).removeClass("badge-review-save");
    $("#static_link_"+qus_id).removeClass("badge-success");
    $("#static_link_"+qus_id).removeClass("badge-danger");
    });
    }
    </script>
