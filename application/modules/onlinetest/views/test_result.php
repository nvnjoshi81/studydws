...
if (($qus_pdf_count>4)&&is_readable($pdf_file_path.$qus_pdf)) {
               echo "<ul class='nav nav-pills'><li><a class='btn btn-raised btn-lg btn-warning' href='".base_url('online-test/getresult/'.encrypt($qus_pdf.'c-h-e-c-k'.$session_customer_id))."' target='_blank'>Download Question File</a></li>";
}
$ans_pdf_count=strlen($ans_pdf);
 if (($ans_pdf_count>4)&&is_readable($pdf_file_path.$ans_pdf)) {              
               echo "<li><a class='btn btn-raised btn-lg btn-success'href='".base_url('online-test/getresult/'.encrypt($ans_pdf.'c-h-e-c-k'.$session_customer_id))."' target='_blank'>Download Answer File</a></li>";
 }
$solution_pdf_count=strlen($solution_pdf);
 if (($solution_pdf_count>4)&&is_readable($pdf_file_path.$solution_pdf)) {
               echo "<li><a class='btn btn-raised btn-lg btn-info' href='".base_url('online-test/getresult/'.encrypt($solution_pdf.'c-h-e-c-k'.$session_customer_id))."' target='_blank'>Download Solution File</a></li></ul>";
 }
 } 
?>
</div><br>
 ...
 <div class="col-md-12" id="report_error">
            ...
            <div class="pull-right col-md-12" id="error_box" style="display:none">
                <form id="error_report" name="error_report">
                    <input type="hidden" name="user_id" value="<?php echo $session_customer_id?$session_customer_id:'0'?>">
...
?>
    <tr <?php  if($count==1){  ?>class='oaerror success' <?php } ?>>
      ...
      <th><?php 
	  if($groupValue['user_id']==$session_customer_id){
	  echo $groupValueObj['obtain_marks'].'/'.$groupValueObj['total_marks'];
	  }else{
	  //echo '****';
	  echo $groupValueObj['obtain_marks'].'/'.$groupValueObj['total_marks'];
	  }
...
<th title="Blank,NULL,Empty and Not Clicked Answer count" >Not Attempted</th>
  ...
  height: 40px;">
                        ...
                        <tr style="<?php echo $rbc_cl; ?>">
                            ...
                            <td>
							<?php echo round($allrow->time_taken / 60, 1); ?></td> 
                    ...
                    <div class="row col-md-12">
                        <div class="col-xs-10 col-xs-offset-1">
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="<?php echo $correct_ans; ?>" aria-valuemin="0" aria-valuemax="<?php echo $totalquestions;?>" style="width: <?php echo ($correct_ans/$totalquestions)*100; ?>%">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="<?php echo $total_not_attq; ?>" aria-valuemin="0" aria-valuemax="<?php echo $totalquestions;?>" style="width: <?php echo ($total_not_attq/$totalquestions)*100; ?>%">
...
//print_r($sections);						
                        ...
                        <div class="col-md-4 text-center" style="padding-top: 10px;<?php if($cc==1){ echo 'border-left: 1px solid #ccc;border-right: 1px solid #ccc;';}?>">
					      ...
					      <div class="col-md-12 text-center">
                                <div class="col-sm-4 nopadding"><b>Marks</b><p><?php if(isset($score)&&$score!=''){echo $score;
								}else{
									echo '0';
