...
/*<!--End All india/Group wise ranking-->*/
	...
	public function attempt_history($testid) {
    ...
    public function test_result($testid) {
        ...
        if(isset($onlinequestioninfo)){
            ...
            foreach ($onlinequestioninfo as $usertest_val) {
                $useranswer_data=$this->Onlinetest_model->getUserAnswerData($testid,$usertest_val->question_id); //print_r($useranswer_data);print_r($usertest_val);
                //die();
