...
class Welcome extends MY_Salescontroller {
  ...
  {  
    ...
    redirect('/'.$this->folder_admin.'/update');
    ...
    function do_upload()
 {
      ...
      function getListingsFromFeed(){
      	 ...
      	 echo '<form name="submitrsslist" id="submitrsslist" method="post" action="'.base_url().$this->folder_admin.'/listings/add_rsslist" onsubmit="getCategoryId();">';
