...
function newCategory(){
        ...
        $('form#category').attr('action', 'Olexam_category/add');
    }    
...
?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Online Test categories</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<form class="new-cat-form"  id="add_category_form" method="post" action="<?php echo base_url();?>admin/Olexam_category/add">
    <?php
    if (isset($result->id)) {
        if ($result->id != NULL) {
    ?>      
   ...
   <div class="form-group">
    ...
    <div class="form-group">
       ...
       <div class="form-group">
        <label>Status</label>
        <input type="text" class="form-control"  id="status" name="status" value="<?php if (isset($result->status)) { echo $result->status;}else{ echo "show";}?>">
    </div>
    ...
    foreach ($subjects as $subject) { ?>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td class="center">
                                        ...
                                        <a href="<?php echo base_url();?>admin/Olexam_category/edit/<?php echo $subject->id;?>" >
                                            <i class="fa fa-edit cat-edit" ></i>
                                        </a>
                                     
                                        <a href="<?php
        echo base_url();
?>admin/Olexam_category/delete/<?php
        echo $subject->id;
