...
return false;
    ...
    $("[name=upload_type]").change(function(){
           ...
           <?php $pdf_file_path=$_SERVER['DOCUMENT_ROOT'].'/upload/pdfs/';?>
    ...
    <input type="hidden" name="chapter_in_db"  value="<?php echo $content_type_chapter_id; ?>" >
     ...
     ?>
       ...
       // print_r($module_file_details[0]);
                ...
                if(isset($module_file_details[0]->file_id)&&($module_file_details[0]->file_id>0&&$module_file_details[0]->question_id==0)){
                $single_question_upload_type='checked';
                $multiple_question_upload_type='';
                $single_qus_display='';
                $multiple_qus_display='display:none';   
...
<div class="col-sm-6 well">
    ...
    <label>Upload Type</label><span class="new-list-spn" id="u_type_single"><input type="radio" name="upload_type"  id="upload_type_single"  value="1" <?php echo $single_question_upload_type;  ?> ><span>Single Question Upload</span></span>
        <span class="new-list-spn" id="u_type_multi"><input type="radio" name="upload_type" value="2" <?php echo $multiple_question_upload_type;  ?> id="upload_type_multiple" ><span>Multiple Question Upload</span></span>
    </div>
  <div class="form-group"> 
        <?php
        ...
        if($newdata=='yes'){
        ?>
        <label id='studypackage_feed_lable'  ><font color="red">Check this box to Create Study Packages with this Module</font>&nbsp;&nbsp;<input type="checkbox"  name="studypackage_feed"  id="studypackage_feed" value="1" ></label><br>
        <?php } ?>
        <label>Contents Name   
            <?php if($newdata=='no'){ ?>
...
if (isset($maincontent->name))
    ...
    <div  class="form-group">
           ...
           <input type="text"  class="form-control" name="display_file_name" value=""  id="display_file_name"/>    
    </div>
        <div  class="form-group">
    ...
    <div class="form-group">
        ...
        ?><label class="url"><?php  echo $pdf_file_name; ?></label><?php echo  ' ['; 
...
if (isset($maincontent->years))
 ...
 ?>
      <!--Online Exam Section-->
      <div id="ol_exam" <?php echo $style_display; ?> >
...
if (isset($maincontent->time))
	...
	echo $maincontent->time;
      ...
      <div class="form-group">  <label>Online Exam Type</label>
        <input class="form-control" type="text" name="exam_type" value="<?php if(isset($maincontent->type)){ echo  $maincontent->type;  } ?>"  id="exam_type"/>    
     </div>
    ...
    <div>
     <input type="hidden" name="existing_playlist_id"  value="<?php echo $existing_playlist_id;  ?>" >
      ...
      <?php
         ...
         $array_existing_playlist_id = array ( 
                '0' => (object) array ( 'id' => '0', 'name' => 'Playlist N.A. .' )
        );        
   ...
   ?>
    ...
    <label>Video By (User Id)</label>
      ...
      if(isset($module_file_details[0]->video_by)){
        $video_by = $module_file_details[0]->video_by;
        }else{
        $video_by='';
                
        }
    ?>
    <input type="text" class="form-control" id="video_by" name="video_by" value="<?php echo $video_by; ?>">
    </div> 
    <div class="form-group">
