...
<?php echo validation_errors(''); ?>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <?php if(!isset($result)){ ?>
            <div class="col-sm-12">
            <a href="#" class="btn btn-success pull-right new-acc">New Tag</a>
...
<form class="new-cat-form"  id="add_category_form" method="post" action="<?php echo base_url(); ?>admin/tags/add">
     <?php if(isset($result) && !isset($tag)) { 
         if($result->id!=NULL){ ?>      
            <h2>Edit Tag</h2>
     <?php } 
        ...
        <?php  if(isset($tags)) { ?>
                ...
                <?php $i=1;
                  ...
                  foreach($tags as $tag){?>
                                ...
                                <tr class="odd gradeX">
                                    <td><?php echo $i; ?></td>
                                    <td><?php if(isset($tag->name)) { echo $tag->name;}?></td>
                                    <td><?php echo $tag->chapter;?></td>
                                    <td><?php if(isset($tag->order)) { echo $tag->order; } ?></td>
                                    <td class="center">
                                       
                                        <a href="<?php echo base_url(); ?>admin/tags/edit/<?php echo $tag->id; ?>" ><i class="fa fa-edit cat-edit" ></i></a>
                                        <a href="<?php echo base_url(); ?>admin/tags/delete/<?php echo $tag->id;?>"><i class="fa fa-trash cat-del"></i></a>
