<div id="page-wrapper">   
    ...
    <div class="row">
        <div class="col-lg-12">
        <h1>Add Livestream<span class="pull-right"><a class="btn btn-primary" href="<?php echo base_url('admin/notification');?>">Livestream List</a></span></h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
    <div class="row">
        <form role="form" id="media-form" class="contact-form" method="post" enctype="multipart/form-data" action="<?php echo base_url('admin/livestream/submitadd'); ?>">
            <div class="row">
                <div class="col-md-6">
