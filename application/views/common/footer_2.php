        ...
        <div class="col-md-12">
            ...
            <div class="col-lg-3 col-sm-6 col-md-6 col-xs-6">
                <a href="<?php echo base_url('videos/jee-main-advanced/28') ?>" title="IIT JEE AIEEE Video Lectures">
                    <img class="img-responsive" width="352" height="302" src="<?php echo base_url('assets/frontend/images/1.png') ?>">
                </a>
            </div>
            <div class="col-lg-3 col-sm-6 col-md-6 col-xs-6" title="NEET Video Lectures">
                <a href="<?php echo base_url('videos/neet/29') ?>">
                    <img width="352" height="302" class="img-responsive" src="<?php echo base_url('assets/frontend/images/2.png') ?>">
                </a>
            </div>
            <div class="col-lg-3 col-sm-6 col-md-6 col-xs-6">
                <a href="<?php echo base_url('videos/12th-class/22') ?>" title="12th Class Video Lectures">
                    <img width="352" height="302" class="img-responsive" src="<?php echo base_url('assets/frontend/images/3.png') ?>">
                </a>
            </div>
            <div class="col-lg-3 col-sm-6 col-md-6 col-xs-6">
                <a href="<?php echo base_url('videos/11th-class/23') ?>" title="11th Class Video Lectures">
                    <img width="352" height="302" class="img-responsive" src="<?php echo base_url('assets/frontend/images/4.png') ?>">
                </a>
            </div>
        </div>
    </div>
...
<footer>
    <div class="container">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="widget">
                            ...
                            &nbsp; 
                            <div class="mailadd"> 
                                <a title="info@studyadda.com" href="mailto:info@studyadda.com">
                                    info@studyadda.com
                                </a>
                            </div>
                            <hr>
                    ...
                    <div class="row col-md-10 foot_link">
                        ...
                        <ul class="row col-xs-12 col-sm-4 col-md-2"><li><h5>9th</h5></li><li><a href="<?php echo base_url('videos/9th/25') ?>" title="videos-9th" >
                                    Videos
                                </a></li>
                                <li><a href="<?php echo base_url('ncert-solution/9th/25'); ?>" title="ncert-solution-9th" >
                                    Ncert Solutions
                                </a></li>
                                <li><a href="<?php echo base_url('question-bank/9th/25'); ?>" title="question-bank-9th" >
                                    Question Bank
                                </a></li>
                                <li><a href="<?php echo base_url('study-packages/9th/25') ?>" title="study-packages-9th" >
                                    Study Packages
                                </a></li>
                                <li><a href="<?php echo base_url('notes/9th/25') ?>" title="notes-9th" >
                                    Notes
                                </a>
                                </li>
                            <li><a href="<?php echo base_url('sample-papers/9th/25'); ?>" title="sample-papers-9th" >
                                    Sample Papers
                                </a></li>
                        </ul>    
                         
                        <ul class="row col-xs-12 col-sm-4 col-md-2"><li><h5>8th</h5></li><li><a href="<?php echo base_url('videos/8th/31') ?>" title="videos-8th">
                                    Videos
                                </a></li>
                        ...
                        <ul class="row col-xs-12 col-sm-4 col-md-2"><li><h5>2nd</h5></li>                            
                                ...
                                <li><a href="<?php echo base_url('study-packages/2nd-class/33') ?>" title="study-packages-2nd" >
                                    Study Packages
                                </a></li>
                        </ul>
                        ...
                        <ul class="row col-xs-12 col-sm-4 col-md-2"><li><h5>1st</h5></li>                            
                                ...
                                <li><a href="<?php echo base_url('study-packages/1st-class/23') ?>" title="study-packages-1st" >
                                    Study Packages
                                </a></li>
                        </ul>
        ...
        <?php echo $k; ?>
                   ...
                   <!-- |<a href="<?php echo base_url('current-affairs') ?>"  title="studyadda articles" >
                        Current Affairs
                    </a>-->
                    |  
                ...
                <p class="copy">
                    ...
                    <a href="<?php echo base_url('privacy-policy') ?>" title="studyadda privacy-policy" >
                        Privacy
                    </a>| 
...
<script src="<?php echo get_assets('assets/frontend/js/pinterest_grid.min.js') ?>"></script>
...
<?php $this->session->unset_userdata('mobileverified'); } ?>
    ...
    function show_contant_count(){
           $('#PopUpprd_count').delay(500).css({"z-index": "99", "visibility": "visible", "opacity": "1", "transition": "all .5s linear"});
     setTimeout(function () {
            $('#PopUpprd_count').css("visibility", "hidden");
        }, 9000);

    }
    
    function hide_contant_count(){
        $('#PopUpprd_count').css("visibility", "hidden");
    }
...
<div id="PopUpprd_count">
    <p style="font-family: 'Open Sans'; font-size: 14px; font-weight: 400; letter-spacing: 0px; color: #555f66; text-align: left;"><span id="panel_prd_popup"><a id="close_prd_popup" onclick="hide_contant_count()" href="#"><i class="fa fa-close" style="font-size:24px;color:red"></i></a><br></span>
    <?php 
...
if($show_new_contant_popup=='yes'){
    if($studymaterial_count>0||$video_count>0){
        ?>
<script>show_contant_count(); </script>
            <?php
    }
...
<script type="text/javascript">
/* <![CDATA[ */
var google_conversion_id = 1050226772;
...
<img height="1" width="1" style="border-style:none;" alt="" src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/1050226772/?value=0&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
<script>
$(document).ready(function() {
 ...
 window.onload = function() {
    ...
    function showbought_subject(examname = null, exam_id = 0, subjectname = null, subject_id = 0, chapter_name = null, chapter_id = 0){       
        ...
        if(exam_id >  0 && subject_id > 0){
            // GET Chapters
            $.ajax({
                url:base_url+"study-material/welcome/showbought_subject/"+examname+'/'+exam_id+'/'+subjectname+'/'+subject_id,  
                dataType:'json',
                success:function(response) {
