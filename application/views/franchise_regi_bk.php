...
<div class="row">
    ...
    <div class="form-group has-success label-floating col-xs-6 col-sm-6 col-md-6">
                                    ...
                                    <span class="material-input"></span>
                                                ...
                                                <div class="row">
        <div class="form-group has-success label-floating is-empty">                    <label for="other" class="control-label">Upload</label>
                                          <input type="text" placeholder="Upload" class="form-control" readonly="">
                                          <input type="file" id="inputFile" name="inputFile">
                                           <span class="material-input"></span>
        </div></div>                <button class="btn btn-raised btn-warning" type="submit">Submit</button>                                     
                                    </form>
                                </div> 
    </div>
    <!--/panel-group-->
