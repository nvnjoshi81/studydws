...
class Livestream_model extends CI_Model
{
    public function getMediaCount(){
        ...
        return $this->db->count_all_results('cmslivestream');
    }
  ...
  $senderIdArray[]=$userInfo->id;
    ...
    public function getMediaById($id){
     ...
     public function editMedia($data, $id) {
        $this->db->update('cmslivestream', $data, array('id' => $id));
    }
    
    public function deleteMedia($id){
      $this->db->delete('cmslivestream',array('id'=>$id));  
    }
