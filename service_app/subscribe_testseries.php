...
if($get_api){
    $result = mysqli_query($conn,"SELECT * FROM cmsonlinetest_relations join cmsonlinetest on cmsonlinetest_relations.onlinetest_id=cmsonlinetest.id where cmsonlinetest_relations.exam_id = '$category' and cmsonlinetest.created_from = 'sample-papers'");
}
