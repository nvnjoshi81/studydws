...
error_reporting(0);
    ...
    if($_POST['category_id'] == "108")
    {
        $tmp['status'] = "success";$tmp['samplepaper_count'] = "0";$tmp['solvedpaper_count'] = "1";$tmp['questionbank_count'] = "1";$tmp['notes_count'] = "0";$tmp['video_count'] = "1";$tmp['studypackage_count'] = "1";$tmp['ncert_count'] = $ncrt_cnt;$tmp['testseries_count'] = "0";
    }
