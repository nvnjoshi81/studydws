 ...
 $package = $_POST['package']; 
  ...
  //}
   ...
   $dtnow = strtotime("now");
	   ...
	   $ind = "INSERT INTO cmscustomers (firstname,email,password,otp,mobile,subject_id,user_key,device_id,status,is_app_registered, created_dt, usertype) VALUES ('$name','$email','$passwordnew','$code','$mobile','$category','$userkey','$device_id','0','1','$dtnow','student')";
