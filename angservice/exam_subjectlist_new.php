...
/*echo "SELECT `cmsvideoslist`.`name`, `cmsvideoslist`.`display_image`, `cmsvideoslist`.`id`, `cmsvideolist_relations`.`id` as `v_relations_id`,
  ...
  `cmsvideolist_relations`.`videolist_id`=`cmsvideoslist`.`id` GROUP BY `cmsvideolist_relations`.`videolist_id` ORDER BY `cmsvideoslist`.`id` DESC LIMIT 12";	 
*/
